...
def compare_vcfs(output_csv="vcf_comparison.csv", unique_vcf="unique_to_vcf2.vcf"):
    ...
    # --- SECOND VCF OUTPUT: unique to vcf2 ---
    with open(unique_vcf, 'w') as outvcf:
        for h in headers2:
            outvcf.write(h)
    ...
    print(f"✅ Unique variants (only in vcf2) saved in: {unique_vcf}")
